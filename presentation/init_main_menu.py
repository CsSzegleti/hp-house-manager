...
from presentation.menu.menu import Menu
...
def init_main_menu(student_manager: StudentManager, house_manager: HouseManager, duel_manager: DuelManager):
    ...
    sub_menu_student_manager = Menu("Student Manager", basic_drawer)
    ...
    sub_menu_house_manager = Menu("House Manager", basic_drawer)
    ...
    main_menu = Menu("Main Menu", basic_drawer)
